...
// Conf action 入参
type Conf struct {
	//TestSpace uint64 `env:"ACTION_TEST_SPACE" required:"true"`
	//TestSet   uint64 `env:"ACTION_TEST_SET" required:"true"`
	TestScene uint64 `env:"ACTION_TEST_SCENE" required:"true"`
...
//func TestSpace() uint64 {
//	return cfg.TestSpace
//}
//
//func TestSet() uint64 {
//	return cfg.TestSet
...
func TestScene() uint64 {
	return cfg.TestScene
}
