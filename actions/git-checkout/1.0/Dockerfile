...
ADD actions/git-checkout/1.0/internal/scripts/install_git_crypt.sh install_git_crypt.sh
...
ADD actions/git-checkout/1.0/internal/assets/ /opt/action/

RUN chmod +x /opt/action/*
