...
func ApplicationGitRepo() string {
	return cfg.ApplicationGitRepo
}
...
func ApplicationGitPassword() string {
	return cfg.ApplicationGitPassword
}

func ParamsApplicationName() string {
	return cfg.ParamsApplicationName
}

func ApplicationType() string {
	return cfg.ApplicationType
}

func IsExternalRepo() bool {
	return cfg.IsExternalRepo
}
