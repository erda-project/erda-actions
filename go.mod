...
replace (
	...
	github.com/erda-project/erda => github.com/dspo/erda v0.0.0-20211105092952-bde24332aa99
...
require (
	...
	github.com/erda-project/erda v1.3.0-rc.0.20211105080141-93d2e088184f
